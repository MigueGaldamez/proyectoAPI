<x-app-layout>
    <x-slot name="header">
        {{ __('Mascotas') }}
        <a href="{{route('mascota.agregar')}}" class="float-end btn btn-success bg-opacity-50 btn-sm">Agregar</a>
    </x-slot>
        ...
        <div class="max-w-9xl mx-auto sm:px-8 lg:px-9">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <tbody>
                    ...
                    <th scope="row">{{$registro->nombre}} - {{$registro->especie->especie}}</th>
                    <td>{{$registro->propietario->nombre_propietario}} {{$registro->propietario->apellido_propietario}}</td>
                    <td>
